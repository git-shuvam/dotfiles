...
export LDFLAGS="-L $HOMEBREW_PREFIX/opt/node@24/lib"
export CPPFLAGS="-I $HOMEBREW_PREFIX/opt/node@24/include"
...
if [[ -d ~/.zfunc ]]; then
	...
	command -v pip3 >/dev/null 2>&1 && pip3 completion --zsh >"$HOME/.zfunc/_pip3"
...
alias rmzfunc="rm -rf $HOME/.zfunc"
